export default function LeadWayLogo() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 35 35"
      fill="none"
      className=" w-[300px] h-[300px] md:w-[300px] md:h-[300px] lg:w-[338.95px] lg:h-[338.95px]  xl:w-[488.95px] xl:h-[488.95px] 2xl:w-[588.95px] 2xl:h-[588.5px]"
    >
      <path
        className="animate-lead-way-path-1"
      ...
      />
      <path
        className="animate-lead-way-path-2"
      ...
      />
      <path
        className="animate-lead-way-path-3"
