...
export default function ValueCard({ item }: { item: ValueItem }) {
  return (
<div className="relative rounded-[20px] border border-gray-200 hover:border-purple-200 w-[220px] h-[60px] md:w-[325px] md:h-[75px] lg:w-[420px] lg:h-[98px]  xl:w-[500px] xl:h-[120px]  2xl:w-[650px] 2xl:h-[130px] p-5 flex items-center gap-4 bg-white 
